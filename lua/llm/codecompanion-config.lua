...
if utils.is_machmotion() then
  ...
  local _17_
  do
    local is_test = os.getenv("IS_TEST")
    if is_test then
      _17_ = true
    else
      _17_ = false
