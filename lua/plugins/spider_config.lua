...
spider_config.keys = {{"<leader>kw", spider_motion("w"), mode = default_modes, desc = "Spider [k]: CamelCase [w]"}, {"<leader>se", spider_motion("e"), mode = default_modes, desc = "Spider [k]: CamelCase [e]"}, {"<leader>sb", spider_motion("b"), mode = default_modes, desc = "Spider [k]: CamelCase [b]"}, {"<leader>sn", do_last_spider(), mode = default_modes, desc = "Spider [k]: Repeat last spider command"}}
local function _1_()
