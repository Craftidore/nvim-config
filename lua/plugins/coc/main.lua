require('packerList').add({'neoclide/coc.nvim', branch='release', config = function()
    local fn = vim.fn
    local opt = vim.opt
    local api = vim.api
