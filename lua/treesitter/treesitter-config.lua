...
treesitter_config = {"nvim-treesitter/nvim-treesitter", keys = {{"<leader>ot", "<CMD>TSContext<CR>", mode = "n", desc = "Open [t]reesitter Info"}}, build = ":TSUpdate", branch = "main", opts = {}, config = _1_, lazy = false}
